...
from tests.unit.fakes import FakeModel, FakeProcessLookup, FakeRepository


def builtin_tools(repo: FakeRepository) -> ToolRegistry:
...
def make_runtime(
    ...
    return AgentRuntime(
        ...
        tools=tools or builtin_tools(repo),
